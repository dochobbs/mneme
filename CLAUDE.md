...
**Data Flow:**
1. Generate patient in **Oread** (JSON export)
2. Drag JSON into **Mneme** Import page
3. Patient available in Mneme for chart review
4. Send patient context to **Echo** for tutoring feedback
...
- Port 8000 conflicts with Oread - run one at a time
